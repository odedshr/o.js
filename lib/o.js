var O = (function 〇Enclosure() {
  ...
  this.TPL = (function TPL() {
    var getDefaultLocale = (function () {
      ...
      stdPattern, // patterns are not initially defined because I the start/end tags might change
      lngPattern,
      ifPattern,
      ifNotPattern,
      loopPattern,
    ...
    var populate = function (string, data) {
      ...
      while ((item = find (loopPattern, string)) !== null) {
        var array = [], loopableElement, i = 0, loopCount, value,
